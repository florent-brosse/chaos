...
func TestModel(t *testing.T) {
	...
	task := Task{"10", USE_CPU, t2, 1, []string{"toto", "DC1"}, make(map[string]string), false, false, 1}
	res2B, _ := json.Marshal(&task)
	//fmt.Println(string(res2B))
	expected := "{\"id\":\"10\",\"type\":\"USE_CPU\",\"start\":\"2017-02-16T00:00:00Z\",\"duration\":1,\"tags\":[\"toto\",\"DC1\"],\"param\":{},\"launched\":false,\"done\":false}"
...
func TestModel2(t *testing.T) {
	t2 := time.Now()
	task := Task{"10", USE_CPU, t2, 60, []string{"toto", "DC1"}, make(map[string]string), false, false, 1}
